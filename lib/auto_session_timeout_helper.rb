...
JS
  ...
  def auto_session_warning_tag(options={})
    ...
    warning_option_buttons = options[:extra_warning_option_buttons] || "<button type='button' class='#{continue_button_classes}' id='session-refresh-button' data-dismiss='modal'>#{continue_button}</button>"
    ...
    expired_option_buttons = options[:extra_expired_option_buttons] || "<a class='#{expired_button_classes}' href='/timeout'>#{expired_button}</a>"
